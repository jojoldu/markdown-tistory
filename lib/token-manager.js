...
const getBlogJsonLocation = function () {
    return ROOT_PATH + 'blog.json';
};

const saveBlogJson = function (blogJson) {
...
exports.getBlogJsonLocation = getBlogJsonLocation;
exports.getBlogJson = getBlogJson;
exports.saveBlogJson = saveBlogJson;
