...
const init = function (inputEditor) {
    ...
    openTokenFile(blogJsonPath, editor, createBlogJson);
};

const ad = function (inputEditor) {
    const editor = createEditor(inputEditor);
    const adTxtPath = tokenManager.getAdTxtLocation();
    openTokenFile(adTxtPath, editor, createAdsenseCode);
};
...
function openTokenFile(filePath, editor, notExistCallback) {
